...
import {
  ...
  FileText, ClipboardCheck, ShieldAlert, Settings, HelpCircle,
  ChevronLeft, ChevronRight, Bike
} from 'lucide-react';
    ...
    >
      ...
      <div className="h-16 flex items-center px-4 border-b border-navy-700/50">
        <div className="flex items-center gap-2 min-w-0">
          <div className="w-8 h-8 rounded-lg bg-gradient-warm flex items-center justify-center flex-shrink-0">
          ...
          <AnimatePresence>
            {!collapsed && (
              ...
              >
                ...
                <span className="text-lg font-dm-sans font-bold text-amber-500 whitespace-nowrap">Moto BF</span>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
