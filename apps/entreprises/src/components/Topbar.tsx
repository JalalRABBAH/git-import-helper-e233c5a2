...
export default function Topbar({ darkMode, toggleDarkMode }: TopbarProps) {
  ...
  const pageTitle = routeNames[location.pathname] || 'iReg Moto BF';
  ...
  return (
    <header className="h-16 bg-white dark:bg-dm-bg-secondary border-b border-navy-200 dark:border-dm-border flex items-center justify-between px-6 sticky top-0 z-40">
      ...
      <div>
        ...
        <h1 className="text-lg font-dm-sans font-bold text-navy-900 dark:text-dm-text-primary leading-tight">{pageTitle}</h1>
      </div>
      ...
      <div className="hidden md:flex items-center">
        <div className="relative w-80">
          ...
          <input
            ...
            className="w-full h-10 pl-10 pr-4 rounded-lg border border-navy-300 dark:border-dm-border bg-white dark:bg-dm-bg-tertiary text-sm text-navy-900 dark:text-dm-text-primary focus:border-terracotta-500 focus:ring-2 focus:ring-terracotta-500/20 outline-none transition-all"
          />
        </div>
      </div>
        ...
        <div className="relative">
          ...
          {notifOpen && (
            <div className="absolute right-0 top-12 w-80 bg-white dark:bg-dm-bg-secondary rounded-xl shadow-lg border border-navy-200 dark:border-dm-border p-4 z-50">
              <h3 className="text-sm font-semibold text-navy-900 dark:text-dm-text-primary mb-2">Notifications</h3>
              <div className="space-y-2">
                <div className="flex items-start gap-2 p-2 rounded-lg bg-warning-50 dark:bg-dm-bg-tertiary">
                  <div className="w-2 h-2 mt-1.5 rounded-full bg-warning-500 flex-shrink-0" />
                  <p className="text-xs text-navy-700 dark:text-dm-text-secondary">Rappel: Rapportage T2 2026 à soumettre avant le 15/07/2026</p>
                </div>
                <div className="flex items-start gap-2 p-2 rounded-lg bg-danger-50 dark:bg-dm-bg-tertiary">
                  <div className="w-2 h-2 mt-1.5 rounded-full bg-danger-500 flex-shrink-0" />
                  <p className="text-xs text-navy-700 dark:text-dm-text-secondary">Alerte: 3 transactions suspectes détectées ce mois</p>
                </div>
                <div className="flex items-start gap-2 p-2 rounded-lg bg-info-50 dark:bg-dm-bg-tertiary">
                  <div className="w-2 h-2 mt-1.5 rounded-full bg-info-500 flex-shrink-0" />
                  <p className="text-xs text-navy-700 dark:text-dm-text-secondary">Mise à jour: Nouveaux modèles interdits publiés par le Ministère</p>
                </div>
              </div>
            </div>
          )}
